              ...
              <div class="table-responsive p-0">
                <table class="table table-borderless">
                  ...
                  <tbody>
                    ...
                    <tr>
                        <td><?=($key_produk+1)?></td><td><?=$val_produk['nama_buku']?></td><td><?=$val_produk['qty']?></td><td><a href="hapus_cart.php?id=<?=$key_produk?>" class="btn btn-danger">hapus<i class="fas fa-trash-alt"></i></a></td>
                    </tr>
                    <?php endforeach ?>
                  </tbody>
                </table>
                <a href="checkout.php"><button type="button" class="btn btn-lg btn-primary">Checkout</button></a>
                <a href="pinjam.php"><button type="button" class="btn btn-secondary btn-lg" disabled>Kembali</button></a>
              </div>
            </div>
          </div>
        </div>
