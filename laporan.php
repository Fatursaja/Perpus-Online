...
session_start();
include "koneksi.php";
$qry_buku=mysqli_query($conn,"select * from buku join peminjaman_buku on peminjaman_buku.id_buku = buku.id_buku");
$no = 0;
?>
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:18%;">Jumlah Pinjam</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                    ...
                                    ?>
                                        <tr class="text-xs font-weight-bold">
                                            ...
                                            <td class="align-middle text-center"><?= $data_buku['jumlah_pinjam'] ?></td>
                                        </tr>
                                    <?php
                                    }
                                    ?>
