<?php
    ...
    if(empty($nama_lengkap)){
        echo "<script>alert('nama user tidak boleh kosong');location.href='tambah_petugas.php';</script>";
        ...
        echo "<script>alert('gender tidak boleh kosong');location.href='tambah_petugas.php';</script>";
    } elseif(empty($alamat)){
        echo "<script>alert('alamat tidak boleh kosong');location.href='tambah_petugas.php';</script>";
    } elseif(empty($email)){
    ...
    if($insert){
        echo "<script>alert('Sukses daftar');location.href='user.php';</script>";
    } else {
        echo "<script>alert('Gagal daftar');location.href='tambah_petugas.php';</script>";
    }
    }
    }
?>