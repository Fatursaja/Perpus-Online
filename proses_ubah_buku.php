            ...
            if(empty($nama_buku)){
                ...
                // } else {
                    if($ukuran < 1044070){          
                        ...
                        $update=mysqli_query($conn,"update buku set nama_buku='".$nama_buku."',penulis='".$penulis."',penerbit='".$penerbit."',tahun_terbit='".$tahun_terbit."',deskripsi='".$deskripsi."', foto='".$namafile."',id_buku='".$id_buku."',id_kategori='".$kategori."' where id_buku= '".$id_buku."'") or die(mysqli_error($conn));
                        if($update){
