    ...
    <div class="wrapper">
		...
		<div class="main">
            ...
            <form action="proses_tambah_kategori.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <input type="submit" name="simpan" value="Tambah Kategori" class="btn btn-outline-primary">
                            <a href="kategori.php"><button type="button" class="btn btn-dark">Kembali</button></a>
                        </div>
                      </section>
						        </form>
