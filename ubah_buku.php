						...
						<div class="col-8">
						   ...
						   <div class="row mb-4">
                                   ...
                                   <div class="col-md-8">
                                        <select name ="id_kategori" class="form-control">
                                             ...
                                             while($kategori = mysqli_fetch_array($kat)){
                                                  ?>
                                                  <option <?php if($kategori['id_kategori']==$dt_buku['id_kategori']) echo 'selected';?> value="<?php echo $kategori['id_kategori'];?>"> <?php echo $kategori['NamaKategori'];?></option>
                                                  <?php
                                             }
                                             ?>
                                        </select>
						    ...
						    <div class="mb-3">
				                   ...
				                   <input type="text" name="penulis" value= "<?=$dt_buku['penulis']?>" class="form-control">
				                </div>
								<div class="mb-3">
				                   <label for="exampleInputEmail1" class="form-label">Penerbit</label>
				                   <input type="text" name="penerbit" value= "<?=$dt_buku['penerbit']?>" class="form-control">
				                </div>
								<div class="mb-3">
				                   <label for="exampleInputEmail1" class="form-label">Tahun Terbit</label>
				                   <input type="text" name="tahun_terbit" value= "<?=$dt_buku['tahun_terbit']?>" class="form-control">
				                </div>
								<div class="mb-3">
